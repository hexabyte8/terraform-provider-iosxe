...
func TestAccDataSourceIosxeCTS(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4.0.ip", "2.2.2.2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4.0.source_ip", "3.3.3.3"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4.0.connection_mode", "local"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4.0.option", "listener"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4.0.hold_time", "60"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4.0.max_time", "300"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.ip", "4.4.4.4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.vrf", "VRF1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.source_ip", "5.5.5.5"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.connection_mode", "local"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.option", "listener"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.hold_time", "60"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_cts.test", "sxp_connection_peers_ipv4_vrf.0.max_time", "300"))
