...
func TestAccDataSourceIosxeISIS(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_isis.test", "log_adjacency_changes", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_isis.test", "log_adjacency_changes_all", "true"))
...
func testAccDataSourceIosxeISISConfig() string {
