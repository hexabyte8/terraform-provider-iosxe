...
func TestAccIosxeObjectGroup(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_object_group.test", "network.0.network_addresses.0.ipv4_address", "10.1.2.0"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccIosxeObjectGroupConfig_minimum(),
			},
			{
...
func testAccIosxeObjectGroupConfig_minimum() string {
...
func testAccIosxeObjectGroupConfig_all() string {
	config := `resource "iosxe_object_group" "test" {` + "\n"
	config += `	fqdn = [{` + "\n"
