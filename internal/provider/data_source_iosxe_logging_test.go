...
func TestAccDataSourceIosxeLogging(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_logging.test", "buffered_size_legacy", "16000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_logging.test", "buffered_severity_legacy", "informational"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_logging.test", "source_interfaces_vrf.0.interface_name", "Loopback200"))
	...
	if os.Getenv("IOSXE1712") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_logging.test", "persistent_url", "bootflash:/local_logging"))
	}
...
func testAccDataSourceIosxeLoggingConfig() string {
	...
	if os.Getenv("IOSXE1712") != "" {
		config += `	persistent_url = "bootflash:/local_logging"` + "\n"
	}
