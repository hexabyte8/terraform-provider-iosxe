...
func TestAccDataSourceIosxeUDLD(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_udld.test", "message_time", "77"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_udld.test", "recovery_interval", "8640"))
...
func testAccDataSourceIosxeUDLDConfig() string {
