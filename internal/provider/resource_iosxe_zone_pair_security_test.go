...
func TestAccIosxeZonePairSecurity(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_zone_pair_security.test", "destination", "OUTSIDE"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_zone_pair_security.test", "description", "Inside to outside traffic policy"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_zone_pair_security.test", "service_policy_type_inspect", "PM_IN_TO_OUT"))
...
func iosxeZonePairSecurityImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccIosxeZonePairSecurityConfig_minimum() string {
...
func testAccIosxeZonePairSecurityConfig_all() string {
	config := `resource "iosxe_zone_pair_security" "test" {` + "\n"
	config += `	name = "ZP_IN_OUT"` + "\n"
	config += `	source = "INSIDE"` + "\n"
	config += `	destination = "OUTSIDE"` + "\n"
