...
func TestAccIosxeBGPIPv4UnicastNeighbor(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bgp_ipv4_unicast_neighbor.test", "soft_reconfiguration", "inbound"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bgp_ipv4_unicast_neighbor.test", "default_originate", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bgp_ipv4_unicast_neighbor.test", "default_originate_route_map", "RM1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_bgp_ipv4_unicast_neighbor.test", "inherit_peer_policy", "PEER_POLICY_TEMPLATE_1"))
...
resource "iosxe_yang" "PreReq1" {
	path = "/Cisco-IOS-XE-native:native/router/Cisco-IOS-XE-bgp:bgp[id=65000]/address-family/no-vrf/ipv4[af-name=unicast]"
	attributes = {
		"af-name" = "unicast"
	}
