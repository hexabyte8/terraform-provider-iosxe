...
func TestAccIosxeASPathAccessList(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_as_path_access_list.test", "name", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_as_path_access_list.test", "entries.0.action", "permit"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_as_path_access_list.test", "entries.0.regex", "^100$"))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccIosxeASPathAccessListConfig_all(),
