...
func TestAccIosxeZoneSecurity(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccIosxeZoneSecurityConfig_minimum(),
			},
			{
...
func iosxeZoneSecurityImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccIosxeZoneSecurityConfig_minimum() string {
	config := `resource "iosxe_zone_security" "test" {` + "\n"
	config += `	name = "INSIDE"` + "\n"
	config += `}` + "\n"
	return config
}
...
func testAccIosxeZoneSecurityConfig_all() string {
	config := `resource "iosxe_zone_security" "test" {` + "\n"
	config += `	name = "INSIDE"` + "\n"
	config += `	description = "Internal trusted network"` + "\n"
	config += `}` + "\n"
	return config
}
