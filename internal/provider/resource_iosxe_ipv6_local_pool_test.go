...
func TestAccIosxeIPv6LocalPool(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_ipv6_local_pool.test", "prefix_length", "64"))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccIosxeIPv6LocalPoolConfig_minimum(),
			},
			{
...
func iosxeIPv6LocalPoolImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccIosxeIPv6LocalPoolConfig_minimum() string {
...
func testAccIosxeIPv6LocalPoolConfig_all() string {
	config := `resource "iosxe_ipv6_local_pool" "test" {` + "\n"
	config += `	name = "DHCPv6-PD"` + "\n"
