...
func TestAccDataSourceIosxeNTP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ntp.test", "source_loopback", "1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ntp.test", "servers.0.burst", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ntp.test", "servers.0.iburst", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ntp.test", "server_vrfs.0.servers.0.burst", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ntp.test", "server_vrfs.0.servers.0.iburst", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_ntp.test", "trusted_keys.0.number", "1"))
