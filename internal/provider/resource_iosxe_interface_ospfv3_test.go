...
func TestAccIosxeInterfaceOSPFv3(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospfv3.test", "bfd", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospfv3.test", "cost", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospfv3.test", "dead_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospfv3.test", "hello_interval", "5"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxe_interface_ospfv3.test", "mtu_ignore", "true"))
