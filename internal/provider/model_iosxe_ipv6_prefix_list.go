...
func (data IPv6PrefixList) getPath() string {
	return "Cisco-IOS-XE-native:native/ipv6/prefix-lists"
}
...
func (data IPv6PrefixList) getPathShort() string {
	path := data.getPath()
...
func (data IPv6PrefixList) getXPath() string {
	path := "/Cisco-IOS-XE-native:native/ipv6/prefix-lists"
	return path
}
...
func (data IPv6PrefixList) toBody(ctx context.Context, config IPv6PrefixList) string {
