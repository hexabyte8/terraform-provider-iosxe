...
func (data BGPAddressFamilyVPNv6) getPath() string {
...
func (data BGPAddressFamilyVPNv6Data) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XE-native:native/router/Cisco-IOS-XE-bgp:bgp=%v/address-family/no-vrf/vpnv6=%s", url.QueryEscape(fmt.Sprintf("%v", data.Asn.ValueString())), url.QueryEscape(fmt.Sprintf("%v", data.AfName.ValueString())))
}
...
func (data BGPAddressFamilyVPNv6Data) getXPath() string {
	path := "/Cisco-IOS-XE-native:native/router/Cisco-IOS-XE-bgp:bgp[id=%v]/address-family/no-vrf/vpnv6[af-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.Asn.ValueString()), fmt.Sprintf("%v", data.AfName.ValueString()))
	return path
}
...
func (data *BGPAddressFamilyVPNv6) fromBodyXML(ctx context.Context, res xmldot.Result) {
}
...
func (data *BGPAddressFamilyVPNv6Data) fromBodyXML(ctx context.Context, res xmldot.Result) {
}
...
func (data *BGPAddressFamilyVPNv6) addDeletePathsXML(ctx context.Context, body string) string {
	b := netconf.NewBody(body)
