...
func TestAccDataSourceIosxeInterfacePortChannelSubinterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_interface_port_channel_subinterface.test", "ipv6_link_local_addresses.0.address", "fe80::9656:d028:8652:66b8"))
