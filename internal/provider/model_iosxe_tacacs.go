...
func (data TACACS) getPath() string {
...
func (data TACACSData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XE-native:native/tacacs/Cisco-IOS-XE-aaa:server=%v", url.QueryEscape(fmt.Sprintf("%v", data.Name.ValueString())))
}
...
func (data TACACSData) getXPath() string {
	path := "/Cisco-IOS-XE-native:native/tacacs/Cisco-IOS-XE-aaa:server[name=%v]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.Name.ValueString()))
	return path
}
...
func (data *TACACS) addDeletedItemsXML(ctx context.Context, state TACACS, body string) string {
	...
	if !state.Port.IsNull() && data.Port.IsNull() {
		b = helpers.RemoveFromXPath(b, state.getXPath()+"/port")
	}
	if !state.Timeout.IsNull() && data.Timeout.IsNull() {
...
func (data *TACACS) addDeletePathsXML(ctx context.Context, body string) string {
	b := netconf.NewBody(body)
	if !data.Key.IsNull() {
	...
	if !data.Port.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/port")
	}
	if !data.Timeout.IsNull() {
