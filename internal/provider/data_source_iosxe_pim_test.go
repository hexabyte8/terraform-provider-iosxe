...
func TestAccDataSourceIosxePIM(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_pim.test", "register_source_interface_loopback", "100"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_pim.test", "vrfs.0.register_source_interface_loopback", "200"))
