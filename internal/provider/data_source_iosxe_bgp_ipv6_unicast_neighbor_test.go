...
func TestAccDataSourceIosxeBGPIPv6UnicastNeighbor(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_bgp_ipv6_unicast_neighbor.test", "default_originate", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_bgp_ipv6_unicast_neighbor.test", "default_originate_route_map", "RM1"))
